...
(
	...
	'palettes' => array
	(
		'default' => '{title_legend},title,poll_type,type,voteInterval,protected,featured,active_behaviorNotVoted,active_behaviorVoted,inactive_behaviorNotVoted,inactive_behaviorVoted;{redirect_legend:hide},jumpTo;{publish_legend},published,closed,activeStart,activeStop,showStart,showStop'
	),
	// Fields
	'fields' => array
	(
		...
		'poll_type' => array
		(
			'label' => &$GLOBALS['TL_LANG']['tl_poll']['poll_type'],
			'exclude' => true,
			'search' => true,
			'inputType' => 'select',
